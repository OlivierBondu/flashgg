...
namespace flashgg {
  ...
  public:
    ...
    DzVertexMapProducer( const ParameterSet &, edm::ConsumesCollector &&);
    ~DzVertexMapProducer();
  private:
...
//    bool useEachTrackOnce_;
  ...
  DzVertexMapProducer::DzVertexMapProducer(const ParameterSet & iConfig):
    DzVertexMapProducer(iConfig, consumesCollector()) {}

  DzVertexMapProducer::DzVertexMapProducer(const ParameterSet & iConfig, edm::ConsumesCollector && iCollector)
  {
...
//    produces<VertexCandidateMap>();
  ...
  DzVertexMapProducer::~DzVertexMapProducer(){
  }
...
// // 
// // //    std::cout << "pvPtrs.size()= " << pvPtrs.size() << "\tpfPtrs.size()= " << pfPtrs.size() << std::endl;
// // 
...
// // //    std::cout << "cand.isNull()= " << cand.isNull() << std::endl;
// // //    std::cout << "cand.isNonnull()= " << cand.isNonnull() << std::endl;
// // //    std::cout << "cand.hasProductCache()= " << cand.hasProductCache() << std::endl;
